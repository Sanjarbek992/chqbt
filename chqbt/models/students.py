...
class Student(models.Model):
    ...
    grade = models.IntegerField(choices=[(10, '10-sinf'), (11, '11-sinf')], db_index=True)
    gender = models.CharField(max_length=6, choices=Gender.choices)
    grade_score = models.DecimalField(max_digits=4, decimal_places=2, null=True, blank=True)
