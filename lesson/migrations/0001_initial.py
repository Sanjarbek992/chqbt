    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lessons', to='location.school')),
            ],
            options={
                'verbose_name': 'Dars',
        ...
        migrations.AddIndex(
            model_name='lesson',
            index=models.Index(fields=['school', 'grade'], name='lesson_less_school__a02603_idx'),
        ),
        migrations.AddIndex(
            model_name='lesson',
            index=models.Index(fields=['school', 'date'], name='lesson_less_school__0b6e23_idx'),
        ),
        migrations.AddIndex(
            model_name='lesson',
            index=models.Index(fields=['lesson_type', 'grade'], name='lesson_less_lesson__269d64_idx'),
        ),
    ]
