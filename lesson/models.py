...
class Lesson(models.Model):
    ...
    lesson_type = models.CharField(
        ...
        verbose_name=_("Mashg‘ulot turi"),
        db_index=True,
    )
...
class LessonSchedule(models.Model):
    lesson = models.ForeignKey(
        Lesson, on_delete=models.CASCADE, related_name="schedule"
    )
...
class LessonMaterial(models.Model):
    lesson = models.ForeignKey(
        Lesson, on_delete=models.CASCADE, related_name="materials", db_index=True
    )
    file = models.FileField(upload_to="lesson_materials/", verbose_name=_("Fayl"))
    uploaded_at = models.DateTimeField(
        auto_now_add=True, verbose_name=_("Yuklangan vaqti"), db_index=True
    )
