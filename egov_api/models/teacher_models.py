...
class Teacher(models.Model):
    pinfl = models.CharField(
        max_length=14, unique=True, verbose_name="PINFL", db_column="pinfl"
    )
    first_name = models.CharField(
        max_length=55, verbose_name="Ismi", db_column="first_name"
    )
    last_name = models.CharField(
        max_length=55, verbose_name="Familiya", db_column="last_name"
    )
    ...
    region = models.CharField(
        max_length=100, blank=True, verbose_name="Tuman", db_column="region"
    )
    oblast = models.CharField(
        max_length=100, blank=True, verbose_name="Viloyat", db_column="oblast"
    )
    organisation_id = models.PositiveIntegerField(
        verbose_name="Maktab ID", db_column="organisation_id"
    )
    organisation_name = models.CharField(
        max_length=255, verbose_name="Maktab nomi", db_column="organisation_name"
    )
    position_name = models.CharField(
        max_length=255, verbose_name="Lavozimi", db_column="position_name"
    )
